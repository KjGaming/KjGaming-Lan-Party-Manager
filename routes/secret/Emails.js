...
exports.adminEmail = function (nickname, birth, email) {
    return '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"' +
        ...
        ' valign="top"> <div mc:edit="std_content00"> <h2 class="h2">Anmeldung</h2> Nickname: ' + nickname + '<br> Geburtstag: ' + birth + '<br> Email: ' + email + '<br> <br> Eure KjGaming </div> </td> </tr> </table> <!-- // End Module: Standard Content \\ --> </td> </tr> </table> <!-- // End Template Body \\ --> </td> </tr> <tr> <td align="center" valign="top"> <!-- // Begin Template Footer \\ --> <table border="0" cellpadding="10" cellspacing="0" width="600" id="templateFooter"> <tr> <td valign="top" class="footerContent"> <!-- // Begin Module: Standard Footer \\ --> <table border="0" cellpadding="10" cellspacing="0" width="100%"> <tr> <td colspan="2" valign="middle" id="social"> <div mc:edit="std_social"> &nbsp;<a href="https://www.instagram.com/kjgamingg/">Instagram</a> | <a href="https://www.facebook.com/KjGaming.LANParty.Filderstadt/">Facebook</a> | <a href="http://steamcommunity.com/groups/kjgaming">Steam</a> | presse[a]kjgaming.de | <a href="https://www.kjgaming.de/">Homepage</a>&nbsp; </div> </td> </tr> <tr> <td valign="top" width="350"> <div mc:edit="std_footer"> <em>Copyright &copy; 2017 KjGaming, All rights reserved.</em> <br /> <br /> <strong>E-Mail ist:</strong> <br /> presse[a]kjgaming.de </div> </td> </tr> </table> <!-- // End Module: Standard Footer \\ --> </td> </tr> </table> <!-- // End Template Footer \\ --> </td> </tr> </table> <br /> </td> </tr> </table> </center> </body> </html>';
};

exports.resetEmail = function (pin, link) {
    return '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"' +
        ' "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html><head><meta http-equiv="Content-Type"' +
        ' content="text/html; charset=UTF-8" /><title>KjGaming[5]</title><style type="text/css">/* Client-specific' +
        ' Styles */#outlook a{padding:0;} /* Force Outlook to provide a "view in browser" button. */body{width:100%' +
        ...
        ' cellspacing="0" width="600" id="templateBody"> <tr> <td valign="top" class="bodyContent"> <!-- // Begin' +
        ' Module: Standard Content \\ --> <table border="0" cellpadding="20" cellspacing="0" width="100%"> <tr> <td' +
        ' valign="top"> <div mc:edit="std_content00"> <h2 class="h2">Passwort vergessen</h2><br><h4 style="text-align: center;"> PIN: ' + pin + '</h4><br> Link: <a href="' + link + '">' + link + '</a><br> <br> <br> Eure KjGaming </div> </td> </tr> </table> <!-- // End Module: Standard Content \\ --> </td> </tr> </table> <!-- // End Template Body \\ --> </td> </tr> <tr> <td align="center" valign="top"> <!-- // Begin Template Footer \\ --> <table border="0" cellpadding="10" cellspacing="0" width="600" id="templateFooter"> <tr> <td valign="top" class="footerContent"> <!-- // Begin Module: Standard Footer \\ --> <table border="0" cellpadding="10" cellspacing="0" width="100%"> <tr> <td colspan="2" valign="middle" id="social"> <div mc:edit="std_social"> &nbsp;<a href="https://www.instagram.com/kjgamingg/">Instagram</a> | <a href="https://www.facebook.com/KjGaming.LANParty.Filderstadt/">Facebook</a> | <a href="http://steamcommunity.com/groups/kjgaming">Steam</a> | presse[a]kjgaming.de | <a href="https://www.kjgaming.de/">Homepage</a>&nbsp; </div> </td> </tr> <tr> <td valign="top" width="350"> <div mc:edit="std_footer"> <em>Copyright &copy; 2017 KjGaming, All rights reserved.</em> <br /> <br /> <strong>E-Mail ist:</strong> <br /> presse[a]kjgaming.de </div> </td> </tr> </table> <!-- // End Module: Standard Footer \\ --> </td> </tr> </table> <!-- // End Template Footer \\ --> </td> </tr> </table> <br /> </td> </tr> </table> </center> </body> </html>';
};